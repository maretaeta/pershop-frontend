            ...
            <div class="flex justify-items-center flex-col text-sm md:text-base w-1/2">
                ...
                <div class="w-1/2">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama" v-model="nama" class="w-full border rounded px-3 py-2">
                    </div>
                    <div>
   ...
   export default {
       ...
       created() {
           ...
           if (this.authStore && this.authStore.user) {
               this.nama = this.authStore.user.nama;
       ...
       methods: {
           ...
           async submitForm() {
               try {
                   if (this.authStore && this.authStore.id_users) {
                       if (this.profilePicture) {
                           await this.authStore.updateProfilePicture(this.authStore.id_users, this.profilePicture);
                       }
                       ...
                       if (this.nama || this.username) {
                           ...
                           await this.authStore.updateUserData(this.authStore.id_users, userData);
                       }
