...
<template>
    <div class="font-poppins w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-white z-30 transition duration-500 ease-in-out"
        ...
        <div @click="handleHome" class="w-full h-24 flex px-5 items-center mb-8 p-5">
        ...
        <div class="mb-4 px-4 text-gray-800">
            ...
            <div @click="handleHome"
                ...
                <span class="text-gray-800 font-medium pl-2 text-lg">Dashboard</span>
            </div>
            <div @click="handleProduct"
                ...
                <span class="text-gray-800 font-medium pl-2 text-lg">Produk</span>
            </div>
            <!-- <div 
            ...
            <div @click="handleHistory"
                ...
                <span class="text-gray-800 font-medium pl-2 text-lg">History</span>
            </div>
        </div>
        <div class="mb-4 px-4 text-gray-800 mt-5">
            ...
            <div 
                ...
                <span class="text-gray-800 font-medium pl-2 text-lg">Analytics</span>
            </div>
        </div>
    </div>
</template>
